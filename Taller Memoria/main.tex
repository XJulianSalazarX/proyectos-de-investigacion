...
La memoria de una computadora es el espacio o el lugar en donde se almacena los datos e instrucciones de un computador, la memoria principal de un computador es la memoria RAM (Random Access Memory), en esta memoria se carga la información de las programas o archivos que están siendo utilizados por el computador, y al dejar de ser usados, son borrados de la memoria, para así de lugar a que pueda usarse otros programas o archivos.
\vspace{0.5cm}
